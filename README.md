...
A typing speed test with **AI-powered practice passages**, weak-key drills, AI coaching, and a full typing arcade (meteor, racer, bubble-pop and comet games). All AI features are powered by the Gemini API.
...
- **AI Practice Passages** — enter any topic (e.g. "Cyberpunk Neo-Tokyo") and get a custom passage. Topic text uses curated samples so the single AI key stays reserved for weak-key drills
- **Weak Key Drills** — auto-detected from your error history, with AI-generated drills (the only feature that consumes the Gemini key)
- **AI Typing Coach** — post-test feedback with actionable tips
- **Typing Arcade** — 4 games: Meteor Storm (planet defense), Speed Racer (drag race), Bubble Pop (deep-sea), Solar Drift (golden solar horizon) — all styled in the KeyMaster theme with matching icons
