...
- **AI Practice Passages** — enter any topic (e.g. "Cyberpunk Neo-Tokyo") and get custom text generated by Gemini
...
- **Typing Arcade** — 4 games: Meteor Storm, Speed Racer, Bubble Pop, Solar Drift (high scores saved locally)
